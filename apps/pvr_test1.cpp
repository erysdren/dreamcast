...
static inline uint32_t transfer_ta_global_polygon(uint32_t store_queue_ix, uint32_t texture_address)
{
  ...
  polygon->tsp_instruction_word = tsp_instruction_word::src_alpha_instr::one
	...
	switch (pvr->width)
	{
		case 8: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_8; break;
		case 16: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_16; break;
		case 32: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_32; break;
		case 64: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_64; break;
		case 128: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_128; break;
		case 256: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_256; break;
		case 512: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_512; break;
		case 1024: polygon->tsp_instruction_word |= tsp_instruction_word::texture_u_size::_1024; break;
	}

	// FIXME: sucks
	switch (pvr->height)
	{
		case 8: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_8; break;
		case 16: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_16; break;
		case 32: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_32; break;
		case 64: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_64; break;
		case 128: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_128; break;
		case 256: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_256; break;
		case 512: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_512; break;
		case 1024: polygon->tsp_instruction_word |= tsp_instruction_word::texture_v_size::_1024; break;
	}
